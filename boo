...
  $(lsb_release -ce" | sudo tee /etc/apt/sources.list.d/docker.list > /dev/null
...
alaoid[['\dka4443334343
\khafjw \[afwmk\"amkfj;'pawjf'ja'fj;fJPQ0U=-UJ]
--payment-provider https://data-seed-prebsc-2-s2.binance.org:8545/ \
--payment-network bsc_testnet \tick
--operator-address xxxxxxxx \
--max-gas-price 
\]][]]l]l]
hardf[aop'[ajf\ [[\k rerrae  rararaeargmgmgjjgdsf
] F,L\[ AKF[\MKAF W[\M
